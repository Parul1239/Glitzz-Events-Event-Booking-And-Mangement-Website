...
if(isset($_SESSION['username']))
	{
		...
		//{
		$result = mysqli_query($con,"SELECT * FROM birthdaybook where username1 = '".$_SESSION['username']."' ") or die( 
		mysqli_error($con));
		
		$result1 = mysqli_query($con,"SELECT * FROM wedbook where username2 = '".$_SESSION['username']."' ") or die( 
		mysqli_error($con));
		
		$result2 = mysqli_query($con,"SELECT * FROM eventbook2 where username3 = '".$_SESSION['username']."' ") or die( 
		mysqli_error($con));
		//}
	}
//else
  // {
    //echo "No Booking Made Yet!!!";  
 // }
